...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BGccz3eC.mjs");
...
var manifest = { "bf3fe5199edff6931d1bab9bc6e8d95b30174e6ba73866b9cdd8fe8c756e6906": {
	functionName: "runAgent_createServerFn_handler",
	importer: () => import("./agent-rpc-BI4wOXm5.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Dlv1kSmr.mjs").then((n) => n.t),
