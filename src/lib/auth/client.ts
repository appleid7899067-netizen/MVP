...
type PuterApi = { auth: { isSignedIn(): boolean; signIn(): Promise<unknown>; signOut(): Promise<unknown>; getUser(): Promise<PuterUser> }; ai: { chat(prompt: unknown, options?: { model?: string; stream?: boolean; temperature?: number }): Promise<unknown>; listModels(): Promise<Array<{ id: string; provider?: string; name?: string }>> } };
